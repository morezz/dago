...
import dago.shiro.session.ShiroSession;
...
//                    LogToDB(e);
    ...
    public void onMessage(final @NotNull Message message, byte[] bytes) {
        ...
        LOGGER.debug("channel {} , message {} ", shiroSessionMessage.getChannel(), shiroSessionMessage.getMsgBody());
        sessionDao.unCache(shiroSessionMessage.getMsgBody().getSessionId());
    }
}
